...
local_pipelines/egoinfinity_hand_pipeline/
  ...
  run_egoinfinity_hand_pipeline.sh
```
...
```text
local_pipelines/egoinfinity_hand_pipeline/egoinfinity_strict/
```
...
```text
<session>/quality/egoinfinity_hand_pipeline/
  stages/
...
```text
local_pipelines/egoinfinity_hand_pipeline/run_egoinfinity_hand_pipeline.sh
```
